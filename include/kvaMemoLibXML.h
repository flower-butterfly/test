 ...
 * outfile.
 *
 * \param[in]   infile            Buffer containing the XML settings.
 * \param[out]  outfile           Buffer to receive the param.lif settings.
 *
 * \return \ref KvaXmlStatusOK (zero) if success.
 * \return \ref KvaXmlStatusERR_XXX (negative) if failure.
 */
 ...
 * xmlfile.
 *
 * \param[in]   parfile           Buffer containing the param.lif settings.
 * \param[out]  xmlfile           Buffer to receive the XML settings.
 *
 * \return \ref KvaXmlStatusOK (zero) if success.
 * \return \ref KvaXmlStatusERR_XXX (negative) if failure.
 */
